      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900">Become a Verified User</h2>
            ...
            {step === 3 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600">How would you like to learn and teach?</p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`w-4 h-4 rounded-full border-2 ${
                        learningMode === 'online' ? 'border-blue-500 bg-blue-500' : 'border-gray-300'
                      }`} />
                      <div>
                        <h4 className="font-semibold text-gray-900">Online Only</h4>
                        <p className="text-sm text-gray-600">Learn through video calls and online sessions</p>
                        <p className="text-xs text-blue-600 mt-1">✓ Video chat links provided automatically</p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`w-4 h-4 rounded-full border-2 ${
                        learningMode === 'offline' ? 'border-blue-500 bg-blue-500' : 'border-gray-300'
                      }`} />
                      <div>
                        <h4 className="font-semibold text-gray-900">In-Person Only</h4>
                        <p className="text-sm text-gray-600">Meet face-to-face in your local area</p>
                        <p className="text-xs text-green-600 mt-1">✓ Enhanced safety features for meetups</p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`w-4 h-4 rounded-full border-2 ${
                        learningMode === 'both' ? 'border-blue-500 bg-blue-500' : 'border-gray-300'
                      }`} />
                      <div>
                        <h4 className="font-semibold text-gray-900">Both Online & In-Person</h4>
                        <p className="text-sm text-gray-600">Flexible learning options based on preference</p>
                        <p className="text-xs text-purple-600 mt-1">✓ Maximum flexibility and opportunities</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-yellow-900">Verification Benefits</h4>
