...
import { Search, Bell, MessageCircle, User, LogOut, Settings, BookOpen, Menu, X, Crown, Star, Moon, Sun } from 'lucide-react';
...
const Header: React.FC = () => {
  ...
  const [hasUnreadComments, setHasUnreadComments] = useState(true);
              ...
              {currentUser ? (
                <>
                  ...
                  >
                    ...
                    {(hasUnreadNotifications || hasUnreadComments) && (
