        ...
        <div className="p-8">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">Unlock advanced features and find more skill matches</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {plans.map((plan) => (
              <div
                ...
                } ${plan.name === 'Premium' ? 'ring-2 ring-blue-200' : ''}`}
              >
                {plan.name === 'Premium' && (
                ...
                <div className="text-center mb-6">
                  <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 ${
                    ...
                    plan.id === 'premium-monthly' ? 'bg-blue-100' : 'bg-purple-100'
                  }`}>
                    {plan.id === 'free' ? (
                  ...
                  <div className="mt-2">
                    ...
                    <span className="text-gray-600">/{plan.duration === 'monthly' ? 'month' : 'year'}</span>
                  </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-700">Integrated video calling</span>
              </div>
              <div className="flex items-center">
                <Shield className="h-5 w-5 text-green-600 mr-2" />
                <span className="text-sm text-gray-700">Enhanced verification</span>
              </div>
              <div className="flex items-center">
