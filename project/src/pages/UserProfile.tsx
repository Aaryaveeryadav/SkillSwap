...
const UserProfile: React.FC = () => {
  ...
  const userReviews = mockReviews.filter(r => r.reviewerId === id);
  ...
  const blockUser = () => {
    if (confirm(`Are you sure you want to block ${user?.name}? You won't see their profile or receive messages from them anymore.`)) {
