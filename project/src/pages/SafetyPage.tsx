...
const SafetyPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {safetyTips.map((tip) => {
            const Icon = tip.icon;
            return (
              <div key={tip.title} className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 text-center">
      ...
      {/* Detailed Guidelines */}
      <div className="mb-16">
        <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Detailed Safety Guidelines</h2>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {guidelines.map((section) => (
            <div key={section.category} className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
      ...
      <div className="bg-red-50 border border-red-200 rounded-xl p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h3 className="font-semibold text-red-900 mb-3">Red Flags in Communication:</h3>
          ...
          <div>
            <h3 className="font-semibold text-red-900 mb-3">Suspicious Behavior:</h3>
            <ul className="space-y-2 text-red-800">
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Report Through the Platform</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Emergency Situations</h3>
            <p className="text-gray-600 mb-4">
              If you're in immediate danger, contact local emergency services first, then report the incident to us.
            </p>
            <div className="space-y-2">
              <p className="text-sm text-gray-600">Emergency: <strong>911</strong></p>
              <p className="text-sm text-gray-600">Crisis Text Line: <strong>Text HOME to 741741</strong></p>
              <p className="text-sm text-gray-600">SkillSwap Safety: <strong>support@skillswap.com</strong></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 rounded-xl p-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Community Standards</h2>
