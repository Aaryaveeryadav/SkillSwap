...
const ReportPage: React.FC = () => {
  ...
  const urgencyLevels = [
    { id: 'low', name: 'Low', color: 'text-green-600 bg-green-100', description: 'Non-urgent issue' },
    { id: 'medium', name: 'Medium', color: 'text-yellow-600 bg-yellow-100', description: 'Needs attention' },
    { id: 'high', name: 'High', color: 'text-orange-600 bg-orange-100', description: 'Urgent issue' },
    { id: 'critical', name: 'Critical', color: 'text-red-600 bg-red-100', description: 'Immediate safety concern' }
  ];
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Report a User</h1>
              ...
              <div className="space-y-2">
                <label className="flex items-center">
                  <input
                    ...
                    className="mr-2"
                  />
                  <span className="text-sm text-gray-700">Email (recommended)</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
                    ...
                    className="mr-2"
                  />
                  <span className="text-sm text-gray-700">Through SkillSwap platform</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
