    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Build meaningful connections through learning</span>
              </div>
              <div className="flex items-center">
                <Target className="h-6 w-6 text-blue-500 mr-3" />
                <span className="text-gray-700">Make skill sharing accessible to everyone</span>
              </div>
              <div className="flex items-center">
                <Users className="h-6 w-6 text-green-500 mr-3" />
                <span className="text-gray-700">Strengthen local communities</span>
              </div>
            </div>
          </div>
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {team.map((member) => (
            <div key={member.name} className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 text-center">
              <img
                src={member.avatar}
                alt={member.name}
      ...
      <div className="bg-gray-50 rounded-2xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3">Authentic Connections</h3>
            <p className="text-gray-600">
