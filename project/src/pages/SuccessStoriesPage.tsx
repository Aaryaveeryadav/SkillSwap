    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
        {stats.map((stat) => {
          ...
          return (
            <div key={stat.label} className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 text-center">
            ...
            <div className="p-8">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center mt-1">
                      ...
                      <span className="ml-2 text-sm text-gray-600">{story.duration}</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-teal-50 rounded-lg p-4">
                  <h3 className="font-semibold text-teal-900 mb-3">Student</h3>
                  <div className="flex items-center space-x-3">
                    <img
                    ...
                    />
                    <div>
                      <p className="font-medium text-gray-900">{story.student.name}</p>
                      <p className="text-sm text-gray-600">{story.student.location}</p>
                      <p className="text-sm text-teal-700">Learned: {story.student.skillLearned}</p>
                    </div>
                  </div>
                </div>

                <div className="bg-purple-50 rounded-lg p-4">
                  <h3 className="font-semibold text-purple-900 mb-3">Teacher</h3>
                  <div className="flex items-center space-x-3">
                    <img
                    ...
                    />
                    <div>
                      <p className="font-medium text-gray-900">{story.teacher.name}</p>
                      <p className="text-sm text-gray-600">{story.teacher.location}</p>
                      <p className="text-sm text-purple-700">Learned: {story.teacher.skillTaught}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            ...
            <div className="flex items-center">
              <img
                ...
                className="w-8 h-8 rounded-full mr-3"
              />
              <span className="text-sm font-medium text-gray-900">Maria Garcia</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            ...
            <div className="flex items-center">
              <img
                ...
                className="w-8 h-8 rounded-full mr-3"
              />
              <span className="text-sm font-medium text-gray-900">James Wilson</span>
            </div>
          </div>
        </div>
      </div>
