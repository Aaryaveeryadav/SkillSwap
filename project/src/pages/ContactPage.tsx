          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Weekend: 10AM - 4PM PST</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="space-y-3">
                <a href="/safety" className="flex items-center text-blue-600 hover:text-blue-700 transition-colors">
                  <HelpCircle className="h-4 w-4 mr-2" />
                  Safety Guidelines
                </a>
                <a href="/success-stories" className="flex items-center text-blue-600 hover:text-blue-700 transition-colors">
      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">How does skill exchange work?</h3>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Is SkillSwap free to use?</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">How do I stay safe while meeting people?</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Can I teach multiple skills?</h3>
            <p className="text-gray-600">
